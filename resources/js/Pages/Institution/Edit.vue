...
const form = useForm({
    sector_id: props.institution.sector_id,
    name: props.institution.name,
    code: props.institution.code,
    responsableInstitution: props.institution.responsableInstitution,
    cargoInstitution: props.institution.cargoInstitution,
    direccionEntrega: props.institution.direccionEntrega,
    phone: props.institution.phone,
    map_google: props.institution.map_google
});
